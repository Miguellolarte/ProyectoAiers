      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Usuario</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
          	...
          	<h2 class="mb-4">¿Como iniciar en el sitio web?</h2>
						<p>-Registrarse de manera correcta para poder adquirir la membresia</p>
						<p>-inicie sesion</p>
						<p>-Dirijase al espacio dedicado para servicios, cada seccion tiene una guia</p>
					</div>
				</div>
			</div>
		</section>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Acontinuacion veras la opinion de algunos usuarios respecto al funcionamineto del sitio web</p>
          </div>
        </div>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2">
                    ...
                    <p>En lo personal me gusto, yo me dedico a decorar hogares y gracias a la pagina encontre mas empleo y mas posibilidades</p>
                    <p class="name">Lisseth Moroy</p>
                    <span class="position">Profecional</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2">
                    ...
                    <p>Yo creo que es buena la idea de utilizar los conociminetos de las personas para que ellos mismos generen sus ingresos</p>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2">
                    ...
                    <p>Me gusta que quieran solucionar el desempleo en tunja.</p>
                    <p class="name">Mark Huff</p>
                    <span class="position">Oferente</span>
                  </div>
                </div>
              </div>
            </div>
			...
			<div class="card-body text-center">
				<form>
					<div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-user"></i></span>
                                            ...
                                            <input type="text" name="txtuser" class="form-control" placeholder="nombre">
					...
					<div class="form-group">
                                            <input type="submit" name="accion" value="Iniciar" class="btn float-right login_btn">
                                                <a href="AgregarUsuario.htm" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
