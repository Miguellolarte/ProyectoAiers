...
<html lang="en">
  <head>
    <title>AIERS - Aplicacion de Ingresos Extra Rapidos y Seguros</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/bg_6.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-6 ftco-animate">
            <h1 class="mb-4">Profecionales</h1>
            <p>Busca al usuario indicado para solucionar tus problemas materiales</p>
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">Saber mas</a></p>
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            <h1 class="mb-4">Genera ingresos adicionales</h1>
            <p>Gana ingresos con las habilidades que tienes</p>
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">Saber mas</a></p>
          </div>
        </div>
        </div>
    ...
    <section class="ftco-services ftco-no-pb">
          ...
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Membrecía</h3>
                <p>Para que puedas ofrecer y solicitar debes comprar una membresia la cual se ajusta a su presupuesto</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Refuerza tus habilidades</h3>
                <p>Realiza servicios relacionados con tus conocimientos y asi reforzarlos</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Los servicios estan relacinados con el mantenimiento,cambio y reparacion de cosas materiales.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Asesoramiento</h3>
                <p>En caso de problemas o conflictos con el uso del sitio web puede contactarce con nosotros</p>
              </div>
            </div>      
          </div>
        </div>
			...
			<div class="container">
				<div class="row d-flex">
					<div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
						<div class="img" style="background-image: url(images/aboutdos.jpg); border"></div>
					</div>
					<div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
          	<h2 class="mb-4">Datos importantes a saber</h2>
						<p>Acontinuacion se mostraran algunos datos que te podrian interesar sobre el sitio web.</p>
						<div class="row mt-5">
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									<div class="icon mt-2 d-flex justify-content-center align-items-center"><span class="flaticon-security"></span></div>
									<div class="text pl-3">
										<h3>Solo somos intermediarios</h3>
										<p>Debes saber que nosotros solo somos intermediarios para que puedas conseguir ingreso solucionando problemas a otras personas</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text pl-3">
										<h3>Membrecia Especial</h3>
										<p>Puedes comprar la membresia que dure un mes hasta un año.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text pl-3">
										<h3>Calificacion</h3>
										<p>A los usuarios que realizan servicios se les podra calificar de tal manera sabremos que tan productivo es..</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text pl-3">
										<h3>Permisos</h3>
										<p>Puedes observar una catidad limitada de toda la informacion de la pagina hasta que compres la membrecia la cualte desbloquea todo el contenido.</p>
									</div>
								</div>
							</div>
    	...
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-2 d-flex">
    			<div class="col-md-6 align-items-stretch d-flex">
    				<div class="img img-video d-flex align-items-center" style="background-image: url(images/movil.jpg);">
		          ...
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
		              ...
		              <div class="text">
		                ...
		                <span>Numero de Admistradores</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		          ...
		          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18">
		              ...
		              <div class="text">
		                ...
		                <span>Mayor ingreso resivido</span>
		              </div>
		            </div>
		          </div>
	          </div>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Tipos de</span> Servicios</h2>
            <p>Los servicios son areas donde las personas se pueden desempeñar y ganar ingresos por solucionarlos</p>
          </div>
        </div>	
				<div class="row">
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/mecanica.jpg);"></div>
						<div class="text pt-4">
							
							<h3><a href="#">Mecanica</a></h3>
							<p>Reparacion,mantenimiento y conservacion de vehiculos.</p>
							
						</div>
					</div>
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/camara.jpg);"></div>
						<div class="text pt-4">
							
							<h3><a href="#">Objetos Tecnologicos</a></h3>
							<p>Reparacion,mantenimiento y conservacion de electrodomesticos y objetos tecnologicos como computadores.</p>
							
						</div>
					</div>
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/sastreria.jpg);"></div>
						<div class="text pt-4">
							
							<h3><a href="#">Sastreria</a></h3>
							<p>confección de ropa y todo lo relacionado con la sastreria</p>
							
						</div>
					</div>
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/plomeria.jpg);"></div>
						<div class="text pt-4">
							
							<h3><a href="#">Plomeria </a></h3>
							<p>persona que se especializa en la instalación y mantenimiento de los sistemas utilizados para el agua potable.</p>
    ...
    <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url(images/sugerencias.jpg);" data-stellar-background-ratio="0.5">
    	<div class="overlay"></div>
    	<div class="container">
    		<div class="row justify-content-end">
    			<div class="col-md-6 py-5 px-md-5">
		          ...
		          <div class="heading-section heading-section-white ftco-animate mb-5">
		            ...
		            <p>Si gusta puede enviarnos sugerencias para mejorar la calidad de nuestros servicios</p>
		          </div>
